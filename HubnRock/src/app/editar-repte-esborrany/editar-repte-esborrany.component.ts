...
export class EditarRepteEsborranyComponent implements OnInit, HasUnsavedData {
  ...
  eliminarFotoArray(fotoName, i) {
    ...
    if (arraySplit[0] == 'fotoPremi') {
      let confirmWindow = confirm('Estàs segur que vol eliminar aquest premi?')
      ...
      let confirmWindow = confirm('Estàs segur que vol eliminar aquesta solució?')
      ...
      let confirmWindow = confirm('Estàs segur que vol eliminar aquest partner?')
      ...
      let confirmWindow = confirm('Estàs segur que vol eliminar aquest jurat?')
